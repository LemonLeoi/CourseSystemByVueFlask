      ...
      <div v-if="selectedTeacher" class="teacher-info">
        ...
        <div class="info-grid">
          ...
          <div class="info-item">
            ...
            <span class="info-value">{{ selectedTeacher.subject }}</span>
          </div>
          <div class="info-item">
...
const emit = defineEmits<{
  (e: 'close'): void;
  (e: 'save', formData: StudentCourse): void;
}>();
...
const selectedTeacher = computed(() => {
  return props.teachers.find(teacher => teacher.id === props.formData.teacher) || null;
});
</script>
